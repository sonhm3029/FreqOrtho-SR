...
def init_tokenizer():
    ...
    tokenizer = BertTokenizer.from_pretrained('bert-base-uncased') # BertTokenizer.from_pretrained('/home/notebook/data/group/LowLevelLLM/LLM/bert-base-uncased', local_files_only=True)
